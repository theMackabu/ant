...
export function targets() {
  ...
  const REGRESSION_TESTS = [
    ...
    'test_napi_clear_exception.cjs',
    'test_cron_continuation_error.cjs',
    'test_assert_pending_rejections.cjs',
    ...
    'test_iterator_close_errors.cjs',
    'test_async_iterator_promise_errors.cjs',
    'test_async_iterator_completed_result.cjs',
    'test_jit_catch_undefined.cjs',
    'test_lock_error_boundaries.cjs',
    'test_tty_error_boundaries.cjs',
    'test_url_error_boundaries.cjs',
    'test_wasm_error_boundaries.cjs',
    'test_ffi_error_boundaries.cjs',
    'test_fs_handled_errors.cjs',
    'test_io_handled_errors.cjs',
    'test_stream_handled_errors.cjs',
    'test_uncaught_callback_exceptions.cjs',
    'test_promise.cjs',
    'test_ant_c.cjs',
    'test_startup_time.cjs',
    'test_syntax.cjs',
    ...
    'test_map_get_template_intrinsic.cjs',
    ...
    'test_regexp_instance_layout.cjs',
    'test_regexp_required_literal.cjs',
    'test_regexp_literal_search_guards.cjs',
    'test_regexp_result_batch.cjs',
    'test_regexp_exec_discard.cjs',
    'test_repl_global_descriptors.cjs',
    'test_object_site_lookup.cjs',
    'test_jit_osr_entry_reject.cjs',
    'test_jit_dnum_get_length.cjs',
    'test_jit_speculative_numeric_elements.cjs',
    'test_jit_speculative_fields_equality_regexp.cjs',
  ...
  const ASYNC_TESTS = [
    ...
    ['test_promise_global_lookup_protector.mjs', 48],
    ['test_promise_protector_hot_store.mjs', 48],
    ['test_promise_resolve_lookup_protector.mjs', 48],
