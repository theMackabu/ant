...
test('Number(BigInt) rounds exact limbs once', Number(8692288669465520373761n) === 8692288669465520373761, true);
test('negative Number(BigInt) rounds exact limbs once', Number(-8692288669465520373761n) === -8692288669465520373761, true);
...
testThrows('1n >>> 0n throws Error', () => 1n >>> 0n, 'BigInts have no unsigned right shift');
