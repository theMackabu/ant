...
const interval = setInterval(() => {
  ...
  console.log(`tick ${count}: arena ${(stats.arenaUsed / 1024 / 1024).toFixed(1)}MB / ${(stats.arenaSize / 1024 / 1024).toFixed(1)}MB, rss ${(stats.rss / 1024 / 1024).toFixed(1)}MB`);
  
  if (count >= 500) {  // Run for ~5 seconds
