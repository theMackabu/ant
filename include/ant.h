...
void js_arr_reserve(ant_t *, ant_value_t arr, uint32_t n);
...
void js_process_promise_thenable_job(ant_t *js, ant_value_t promise, ant_value_t thenable, ant_value_t then_fn);
