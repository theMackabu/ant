...
OP_FLAG(OBJECT                , SV_OPF_JIT_ELIGIBLE | SV_OPF_JIT_INLINEABLE)
...
OP_FLAG(SET_LOCAL_UNDEF       , SV_OPF_JIT_ELIGIBLE | SV_OPF_JIT_INLINEABLE)
OP_FLAG(GET_SLOT_RAW          , SV_OPF_JIT_ELIGIBLE)

OP_FLAG(GET_ARG               , SV_OPF_JIT_ELIGIBLE | SV_OPF_JIT_INLINEABLE)
OP_FLAG(SET_ARG               , SV_OPF_JIT_ELIGIBLE | SV_OPF_JIT_INLINEABLE | SV_OPF_JIT_NEEDS_BAILOUT)
OP_FLAG(PUT_ARG               , SV_OPF_JIT_ELIGIBLE | SV_OPF_JIT_INLINEABLE | SV_OPF_JIT_NEEDS_BAILOUT)
...
OP_FLAG(BAND                  , SV_OPF_JIT_ELIGIBLE | SV_OPF_JIT_INLINEABLE | SV_OPF_JIT_NEEDS_BAILOUT)
OP_FLAG(BOR                   , SV_OPF_JIT_ELIGIBLE | SV_OPF_JIT_INLINEABLE | SV_OPF_JIT_NEEDS_BAILOUT)
OP_FLAG(BXOR                  , SV_OPF_JIT_ELIGIBLE | SV_OPF_JIT_INLINEABLE | SV_OPF_JIT_NEEDS_BAILOUT)
OP_FLAG(BNOT                  , SV_OPF_JIT_ELIGIBLE | SV_OPF_JIT_NEEDS_BAILOUT)
OP_FLAG(SHL                   , SV_OPF_JIT_ELIGIBLE | SV_OPF_JIT_INLINEABLE | SV_OPF_JIT_NEEDS_BAILOUT)
OP_FLAG(SHR                   , SV_OPF_JIT_ELIGIBLE | SV_OPF_JIT_INLINEABLE | SV_OPF_JIT_NEEDS_BAILOUT)
OP_FLAG(USHR                  , SV_OPF_JIT_ELIGIBLE | SV_OPF_JIT_INLINEABLE | SV_OPF_JIT_NEEDS_BAILOUT)

OP_FLAG(NOT                   , SV_OPF_JIT_ELIGIBLE | SV_OPF_JIT_INLINEABLE)
...
OP_FLAG(JMP                   , SV_OPF_JIT_ELIGIBLE | SV_OPF_JIT_INLINEABLE | SV_OPF_JIT_BRANCH32 | SV_OPF_JIT_OSR_BACKEDGE | SV_OPF_TERMINAL)
...
OP_FLAG(JMP8                  , SV_OPF_JIT_ELIGIBLE | SV_OPF_JIT_BRANCH8 | SV_OPF_JIT_OSR_BACKEDGE | SV_OPF_TERMINAL)
...
OP_FLAG(TAIL_MAP_TEMPLATE     , SV_OPF_JIT_ELIGIBLE | SV_OPF_JIT_NEEDS_BAILOUT | SV_OPF_JIT_NEEDS_ARGS_BUF | SV_OPF_TERMINAL)
OP_FLAG(TAIL_CALL             , SV_OPF_JIT_ELIGIBLE | SV_OPF_JIT_INLINEABLE | SV_OPF_JIT_NEEDS_ARGS_BUF | SV_OPF_JIT_NEEDS_TCO_ARGS | SV_OPF_JIT_NEEDS_IC_EPOCH | SV_OPF_JIT_INLINE_ARGC | SV_OPF_TERMINAL)
OP_FLAG(TAIL_CALL_METHOD      , SV_OPF_JIT_ELIGIBLE | SV_OPF_JIT_INLINEABLE | SV_OPF_JIT_NEEDS_ARGS_BUF | SV_OPF_JIT_NEEDS_TCO_ARGS | SV_OPF_JIT_NEEDS_IC_EPOCH | SV_OPF_JIT_INLINE_ARGC | SV_OPF_TERMINAL)
...
OP_FLAG(RETURN                , SV_OPF_JIT_ELIGIBLE | SV_OPF_JIT_INLINEABLE | SV_OPF_TERMINAL)
OP_FLAG(RETURN_UNDEF          , SV_OPF_JIT_ELIGIBLE | SV_OPF_JIT_INLINEABLE | SV_OPF_TERMINAL)
OP_FLAG(RETURN_ASYNC          , SV_OPF_TERMINAL)
OP_FLAG(CHECK_CTOR            , SV_OPF_JIT_ELIGIBLE)
OP_FLAG(HALT                  , SV_OPF_JIT_ELIGIBLE | SV_OPF_TERMINAL)

OP_FLAG(THROW                 , SV_OPF_JIT_ELIGIBLE | SV_OPF_TERMINAL)
OP_FLAG(THROW_ERROR           , SV_OPF_JIT_ELIGIBLE | SV_OPF_TERMINAL)
...
OP_FLAG(UNWIND_JMP            , SV_OPF_JIT_BRANCH32 | SV_OPF_TERMINAL)
OP_FLAG(FINALLY_RET           , SV_OPF_TERMINAL)
