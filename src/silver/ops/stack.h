...
static inline void sv_op_dup2(sv_vm_t *vm) {
  jsval_t a = vm->stack[vm->sp - 2];
  jsval_t b = vm->stack[vm->sp - 1];
  vm->stack[vm->sp++] = a;
  vm->stack[vm->sp++] = b;
}
...
static inline void sv_op_insert3(sv_vm_t *vm) {
  jsval_t a = vm->stack[vm->sp - 1];
  jsval_t prop = vm->stack[vm->sp - 2];
  jsval_t obj = vm->stack[vm->sp - 3];
  vm->stack[vm->sp - 3] = a;
...
static inline void sv_op_swap_under(sv_vm_t *vm) {
  jsval_t tmp = vm->stack[vm->sp - 3];
  vm->stack[vm->sp - 3] = vm->stack[vm->sp - 2];
  vm->stack[vm->sp - 2] = tmp;
}

static inline void sv_op_rot4_under(sv_vm_t *vm) {
  jsval_t a = vm->stack[vm->sp - 4];
  jsval_t b = vm->stack[vm->sp - 3];
  jsval_t c = vm->stack[vm->sp - 2];
  vm->stack[vm->sp - 4] = c;
  vm->stack[vm->sp - 3] = a;
  vm->stack[vm->sp - 2] = b;
}
