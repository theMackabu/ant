...
static ant_value_t tls_socket_drain_read_queue(ant_params_t) {
...
static ant_value_t js_tls_context_close(ant_params_t) {
...
static void tls_init_context_proto(ant_t *js) {
  if (js->builtins.tls_context_proto && js->builtins.tls_context_ctor) return;
...
static ant_value_t js_tls_socket_read(ant_params_t) {
...
static ant_value_t js_tls_socket_unshift(ant_params_t) {
  ant_tls_socket_t *socket = tls_require_socket(js, js_getthis(js));
...
static ant_value_t js_tls_socket_write(ant_params_t) {
  ant_tls_socket_t *socket = tls_require_socket(js, js_getthis(js));
  const uint8_t *bytes = NULL;
  size_t len = 0;
...
static ant_value_t js_tls_socket_end(ant_params_t) {
  ant_tls_socket_t *socket = tls_require_socket(js, js_getthis(js));
...
static ant_value_t js_tls_socket_setEncoding(ant_params_t) {
  ant_tls_socket_t *socket = tls_require_socket(js, js_getthis(js));
...
static ant_value_t js_tls_socket_setKeepAlive(ant_params_t) {
  ant_tls_socket_t *socket = tls_require_socket(js, js_getthis(js));
  bool enable = nargs > 0 && js_truthy(js, args[0]);
...
static ant_value_t js_tls_socket_cork(ant_params_t) {
  return js_getthis(js);
}

static ant_value_t js_tls_socket_uncork(ant_params_t) {
  return js_getthis(js);
}
...
static ant_value_t js_tls_socket_getCipher(ant_params_t) {
  return js_mkundef();
}

static ant_value_t js_tls_socket_getSession(ant_params_t) {
  return js_mkundef();
}

static ant_value_t js_tls_socket_getPeerCertificate(ant_params_t) {
  return js_mkobj(js);
}

static ant_value_t js_tls_socket_renegotiate(ant_params_t) {
  ant_value_t callback = js_mkundef();
...
static ant_value_t js_tls_socket_ctor(ant_params_t) {
  ...
  if (tls_socket_data(existing)) {
    ...
    js_set_proto_wb(js, existing, js->builtins.tls_socket_proto);
    return existing;
  }

  obj = js_mkobj(js);
  proto = js_instance_proto_from_new_target(js, js->builtins.tls_socket_proto, call_new_target);
...
void tls_init_socket_proto(ant_t *js) {
  ...
  if (js->builtins.tls_socket_proto && js->builtins.tls_socket_ctor) return;

  if (!js->builtins.tls_socket_proto) {
    net = net_library(js);
    ...
    js->builtins.tls_socket_proto = js_mkobj(js);
    if (is_object_type(net_socket_proto)) js_set_proto_init(js->builtins.tls_socket_proto, net_socket_proto);
    js_set(js, js->builtins.tls_socket_proto, "read", js_mkfun(js_tls_socket_read));
    js_set(js, js->builtins.tls_socket_proto, "unshift", js_mkfun(js_tls_socket_unshift));
    js_set(js, js->builtins.tls_socket_proto, "write", js_mkfun(js_tls_socket_write));
    js_set(js, js->builtins.tls_socket_proto, "end", js_mkfun(js_tls_socket_end));
    js_set(js, js->builtins.tls_socket_proto, "destroy", js_mkfun(js_tls_socket_destroy));
    js_set(js, js->builtins.tls_socket_proto, "pause", js_mkfun(js_tls_socket_pause));
    js_set(js, js->builtins.tls_socket_proto, "resume", js_mkfun(js_tls_socket_resume));
    js_set(js, js->builtins.tls_socket_proto, "setEncoding", js_mkfun(js_tls_socket_setEncoding));
    js_set(js, js->builtins.tls_socket_proto, "setNoDelay", js_mkfun(js_tls_socket_setNoDelay));
    js_set(js, js->builtins.tls_socket_proto, "setKeepAlive", js_mkfun(js_tls_socket_setKeepAlive));
    js_set(js, js->builtins.tls_socket_proto, "setTimeout", js_mkfun(js_tls_socket_setTimeout));
    js_set(js, js->builtins.tls_socket_proto, "address", js_mkfun(js_tls_socket_address));
    js_set(js, js->builtins.tls_socket_proto, "ref", js_mkfun(js_tls_socket_ref));
    js_set(js, js->builtins.tls_socket_proto, "unref", js_mkfun(js_tls_socket_unref));
    js_set(js, js->builtins.tls_socket_proto, "cork", js_mkfun(js_tls_socket_cork));
    js_set(js, js->builtins.tls_socket_proto, "uncork", js_mkfun(js_tls_socket_uncork));
    js_set(js, js->builtins.tls_socket_proto, "getProtocol", js_mkfun(js_tls_socket_getProtocol));
    js_set(js, js->builtins.tls_socket_proto, "getCipher", js_mkfun(js_tls_socket_getCipher));
  ...
  if (!js->builtins.tls_socket_ctor)
    js->builtins.tls_socket_ctor = js_make_ctor(js, js_tls_socket_ctor, js->builtins.tls_socket_proto, "TLSSocket", 9);
}

static ant_value_t js_tls_create_context(ant_params_t) {
  ...
  obj = js_mkobj(js);
  js_set_proto_init(obj, js->builtins.tls_context_proto);
  wrap->obj = obj;
...
static ant_value_t js_tls_is_context(ant_params_t) {
...
static ant_value_t js_tls_connect_options(ant_t *js, ant_value_t options, ant_value_t callback) {
  ...
  obj = js_mkobj(js);
  js_set_proto_init(obj, js->builtins.tls_socket_proto);
  socket->obj = obj;
...
static ant_value_t js_tls_check_server_identity(ant_params_t) {
  return js_mkerr_typed(js, JS_ERR_TYPE, "tls.checkServerIdentity is not implemented");
}

static ant_value_t js_tls_get_ciphers(ant_params_t) {
  return js_mkarr(js);
}
...
static ant_value_t tls_build_library(ant_t *js) {
  ...
  if (!js->builtins.tls_context_ctor) js->builtins.tls_context_ctor = js_make_ctor(
    js, js_tls_secure_context_ctor,
    js->builtins.tls_context_proto, "SecureContext", 13
  );
  
  js_set(js, lib, "version", version);
  js_set(js, lib, "TLSSocket", js->builtins.tls_socket_ctor);
  js_set(js, lib, "SecureContext", js->builtins.tls_context_ctor);
  ...
  builtin_object_freeze(js, &root_certificates, 1, js_mkundef());
