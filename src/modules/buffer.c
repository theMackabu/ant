...
void init_buffer_module() {
  ...
  set_slot(js, arraybuffer_ctor_obj, SLOT_NATIVE_FUNC, js_mkfun(js_arraybuffer_constructor));
  ...
  #define SETUP_TYPEDARRAY(name) \
    do { \
      ...
      set_slot(js, name##_ctor_obj, SLOT_NATIVE_FUNC, js_mkfun(js_##name##_constructor)); \
