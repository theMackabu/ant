...
static ant_value_t ffi_make_pointer(ant_t *js, ffi_pointer_region_t *region, size_t byte_offset) {
  ...
  if (js->builtins.ffi_pointer_proto) js_set_proto_init(obj, js->builtins.ffi_pointer_proto);
...
static ant_value_t ffi_make_function(ant_t *js, ffi_library_handle_t *library, const char *symbol_name, ffi_signature_t *signature, void *func_ptr) {
  ...
  if (js->builtins.ffi_function_proto) js_set_proto_init(obj, js->builtins.ffi_function_proto);
...
static void ffi_init_prototypes(ant_t *js) {
  ...
  js->builtins.ffi_pointer_proto = js_mkobj(js);
  js->builtins.ffi_callback_proto = js_mkobj(js);

  if (is_object_type(js->sym.object_proto)) {
    js_set_proto_init(js->builtins.ffi_library_proto, js->sym.object_proto);
    js_set_proto_init(js->builtins.ffi_pointer_proto, js->sym.object_proto);
    js_set_proto_init(js->builtins.ffi_callback_proto, js->sym.object_proto);
  }
  ...
  js_set(js, js->builtins.ffi_library_proto, "close", js_mkfun(ffi_library_close));

  js_set(js, js->builtins.ffi_pointer_proto, "address", js_mkfun(ffi_pointer_address));
  js_set(js, js->builtins.ffi_pointer_proto, "isNull", js_mkfun(ffi_pointer_is_null));
  js_set(js, js->builtins.ffi_pointer_proto, "read", js_mkfun(ffi_pointer_read));
  js_set(js, js->builtins.ffi_pointer_proto, "write", js_mkfun(ffi_pointer_write));
  js_set(js, js->builtins.ffi_pointer_proto, "offset", js_mkfun(ffi_pointer_offset));
  js_set(js, js->builtins.ffi_pointer_proto, "free", js_mkfun(ffi_pointer_free));

  js_set(js, js->builtins.ffi_callback_proto, "address", js_mkfun(ffi_callback_address));
  js_set(js, js->builtins.ffi_callback_proto, "close", js_mkfun(ffi_callback_close));
...
static ant_value_t ffi_dlopen(ant_t *js, ant_value_t *args, int nargs) {
  ...
  obj = js_mkobj(js);
  if (js->builtins.ffi_library_proto) js_set_proto_init(obj, js->builtins.ffi_library_proto);
  library->obj = obj;
...
static ant_value_t ffi_create_callback(ant_t *js, ant_value_t *args, int nargs) {
  ...
  obj = js_mkobj(js);
  if (js->builtins.ffi_callback_proto) js_set_proto_init(obj, js->builtins.ffi_callback_proto);
