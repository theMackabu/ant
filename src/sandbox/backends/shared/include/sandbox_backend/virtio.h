...
bool ant_hvf_virtio_device_config_read(
  ant_hvf_vm_t *vm,
  ant_hvf_virtio_device_t *dev,
  uint64_t off,
  unsigned size,
...
bool ant_hvf_virtio_msix_write(
  ant_hvf_vm_t *vm,
  ant_hvf_virtio_device_t *dev,
  uint64_t off,
  unsigned size,
...
bool ant_hvf_virtio_common_read(
  ant_hvf_vm_t *vm,
  ant_hvf_virtio_device_t *dev,
  uint64_t off,
  unsigned size,
...
bool ant_hvf_virtio_common_write(
  ant_hvf_vm_t *vm,
  ant_hvf_virtio_device_t *dev,
  uint64_t off,
  unsigned size,
