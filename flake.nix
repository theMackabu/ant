# Generated by packages/nix/generate.ts; edit the TypeScript source.
{
...
in (let
  __tsnix_6_toolchain = ((import) (./packages/nix/toolchain.nix) ({
  pkgs = __tsnix_5_pkgs;
}));
  ...
  __tsnix_9_ant = (((__tsnix_5_pkgs).callPackage) (./packages/nix/package.nix) ({
...
in {
  ...
  devShells = {
    default = ((import) (./packages/nix/shell.nix) ({
  pkgs = __tsnix_5_pkgs;
