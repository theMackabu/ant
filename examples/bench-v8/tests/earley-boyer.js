...
sc_Tokenizer.prototype.nextToken = function () {
  ...
  function readSharp() {
    ...
    if (c === '\\') {
      ...
      switch (tmp.length) {
        ...
        default:
          ...
          else return new sc_Token(13 /*ERROR*/, 'unknown character description: #\\' + tmp);
      }
    }
    ...
    while (true) {
      ...
      else if (isWhitespace(c) || needing == '') return new sc_Token(13 /*ERROR*/, 'bad #-pattern4 ' + c + ' ' + needing);
    ...
    while (true) {
      ...
      switch (token.type) {
        ...
        case 10 /*DOT*/:
          ...
          if (!matchesPeer(listBeginType, par.type)) throw "closing par doesn't match: " + listBeginType + ' ' + par.type;
...
var sc_const_4_nboyer;
{
  sc_const_4_nboyer = new sc_Pair(
    ...
    new sc_Pair(
              ...
              new sc_Pair(
                ...
                new sc_Pair(
                  new sc_Pair(
                    '\u1E9Cand',
                    new sc_Pair(
                      new sc_Pair('\u1E9Cimplies', new sc_Pair('\u1E9Cz', new sc_Pair('\u1E9Cu', null))),
                      new sc_Pair(new sc_Pair('\u1E9Cimplies', new sc_Pair('\u1E9Cu', new sc_Pair('\u1E9Cw', null))), null)
                    )
                  ),
                  null
                )
      ...
      new sc_Pair(new sc_Pair('\u1E9Cimplies', new sc_Pair('\u1E9Cx', new sc_Pair('\u1E9Cw', null))), null)
    )
  );
  sc_const_3_nboyer = sc_list(
        ...
        new sc_Pair(
          new sc_Pair(
            ...
            new sc_Pair(
              new sc_Pair(
                '\u1E9Ccodegen',
                new sc_Pair(new sc_Pair('\u1E9Coptimize', new sc_Pair('\u1E9Cform', null)), new sc_Pair(new sc_Pair('\u1E9Cnil', null), null))
              ),
              null
            )
          ),
    ...
    new sc_Pair(
      ...
      new sc_Pair(
        ...
        new sc_Pair(new sc_Pair('\u1E9Clessp', new sc_Pair('\u1E9Cy', new sc_Pair('\u1E9Cx', null))), null)
      )
    ),
    new sc_Pair(
      '\u1E9Cequal',
      new sc_Pair(
        ...
        new sc_Pair(
          new sc_Pair('\u1E9Cnot', new sc_Pair(new sc_Pair('\u1E9Clessp', new sc_Pair('\u1E9Cy', new sc_Pair('\u1E9Cx', null))), null)),
          null
        )
      )
    ),
    new sc_Pair(
      ...
      new sc_Pair(
        ...
        new sc_Pair(
          new sc_Pair('\u1E9Cnot', new sc_Pair(new sc_Pair('\u1E9Clessp', new sc_Pair('\u1E9Cx', new sc_Pair('\u1E9Cy', null))), null)),
          null
        )
      )
    ),
      ...
      new sc_Pair(
        ...
        new sc_Pair(
          new sc_Pair(
            '\u1E9Cor',
            new sc_Pair(
              new sc_Pair('\u1E9Cequal', new sc_Pair('\u1E9Cx', new sc_Pair(new sc_Pair('\u1E9Ct', null), null))),
              new sc_Pair(new sc_Pair('\u1E9Cequal', new sc_Pair('\u1E9Cx', new sc_Pair(new sc_Pair('\u1E9Cf', null), null))), null)
            )
          ),
          null
        )
      ...
      new sc_Pair(
        ...
        new sc_Pair(
          new sc_Pair(
            ...
            new sc_Pair(
              new sc_Pair('\u1E9Cimplies', new sc_Pair('\u1E9Cx', new sc_Pair('\u1E9Cy', null))),
              new sc_Pair(new sc_Pair('\u1E9Cimplies', new sc_Pair('\u1E9Cy', new sc_Pair('\u1E9Cx', null))), null)
            )
          ),
          null
        )
        ...
        new sc_Pair(
          new sc_Pair(
            ...
            new sc_Pair(
              ...
              new sc_Pair(
                new sc_Pair('\u1E9Ct', null),
                new sc_Pair(new sc_Pair('\u1E9Codd', new sc_Pair(new sc_Pair('\u1E9Csub1', new sc_Pair('\u1E9Cx', null)), null)), null)
              )
            )
          ),
          null
    ...
    new sc_Pair(
      ...
      new sc_Pair(
        ...
        new sc_Pair(
          new sc_Pair('\u1E9Ccountps-loop', new sc_Pair('\u1E9Cl', new sc_Pair('\u1E9Cpred', new sc_Pair(new sc_Pair('\u1E9Czero', null), null)))),
          null
        )
      )
    ),
    new sc_Pair(
      ...
      new sc_Pair(
        ...
        new sc_Pair(new sc_Pair('\u1E9Cfact-loop', new sc_Pair('\u1E9Ci', new sc_Pair(1, null))), null)
      )
    ),
    new sc_Pair(
      '\u1E9Cequal',
      new sc_Pair(
        ...
        new sc_Pair(new sc_Pair('\u1E9Creverse-loop', new sc_Pair('\u1E9Cx', new sc_Pair(new sc_Pair('\u1E9Cnil', null), null))), null)
      )
    ),
    new sc_Pair(
      '\u1E9Cequal',
      new sc_Pair(
        ...
        new sc_Pair(
          new sc_Pair('\u1E9Czerop', new sc_Pair(new sc_Pair('\u1E9Cremainder', new sc_Pair('\u1E9Cy', new sc_Pair('\u1E9Cx', null))), null)),
          null
        )
      )
    ),
    new sc_Pair(
      '\u1E9Cequal',
      new sc_Pair(
        new sc_Pair('\u1E9Cassume-true', new sc_Pair('\u1E9Cvar', new sc_Pair('\u1E9Calist', null))),
        new sc_Pair(
          new sc_Pair(
            '\u1E9Ccons',
            new sc_Pair(
              new sc_Pair('\u1E9Ccons', new sc_Pair('\u1E9Cvar', new sc_Pair(new sc_Pair('\u1E9Ct', null), null))),
    ...
    new sc_Pair(
      '\u1E9Cequal',
      new sc_Pair(
        new sc_Pair('\u1E9Cassume-false', new sc_Pair('\u1E9Cvar', new sc_Pair('\u1E9Calist', null))),
        new sc_Pair(
          new sc_Pair(
            '\u1E9Ccons',
            new sc_Pair(
              new sc_Pair('\u1E9Ccons', new sc_Pair('\u1E9Cvar', new sc_Pair(new sc_Pair('\u1E9Cf', null), null))),
              new sc_Pair('\u1E9Calist', null)
            )
          ),
          null
    ...
    new sc_Pair(
      ...
      new sc_Pair(
        ...
        new sc_Pair(
          new sc_Pair(
            '\u1E9Ctautologyp',
            new sc_Pair(new sc_Pair('\u1E9Cnormalize', new sc_Pair('\u1E9Cx', null)), new sc_Pair(new sc_Pair('\u1E9Cnil', null), null))
          ),
          null
        )
      )
      ...
      new sc_Pair(
        ...
        new sc_Pair(
          new sc_Pair(
            '\u1E9Cand',
            new sc_Pair(
              new sc_Pair('\u1E9Cnot', new sc_Pair(new sc_Pair('\u1E9Czerop', new sc_Pair('\u1E9Cx', null)), null)),
              new sc_Pair(
                new sc_Pair(
                  '\u1E9Cnot',
                  new sc_Pair(
                    new sc_Pair(
                      '\u1E9Cequal',
                      new sc_Pair('\u1E9Cx', new sc_Pair(new sc_Pair('\u1E9Cadd1', new sc_Pair(new sc_Pair('\u1E9Czero', null), null)), null))
                    ),
                    null
                  )
                ),
                new sc_Pair(
                  new sc_Pair('\u1E9Cprime1', new sc_Pair('\u1E9Cx', new sc_Pair(new sc_Pair('\u1E9Csub1', new sc_Pair('\u1E9Cx', null)), null))),
                  null
                )
              )
            )
          ...
          new sc_Pair(
            ...
            new sc_Pair(
              ...
              new sc_Pair(
                new sc_Pair(
                  '\u1E9Cif',
                  new sc_Pair('\u1E9Cq', new sc_Pair(new sc_Pair('\u1E9Ct', null), new sc_Pair(new sc_Pair('\u1E9Cf', null), null)))
                ),
    ...
    new sc_Pair(
      ...
      new sc_Pair(
        ...
        new sc_Pair(
          new sc_Pair('\u1E9Cif', new sc_Pair('\u1E9Cp', new sc_Pair(new sc_Pair('\u1E9Cf', null), new sc_Pair(new sc_Pair('\u1E9Ct', null), null)))),
          null
        )
      )
    ),
    ...
    new sc_Pair(
      ...
      new sc_Pair(
        new sc_Pair(
          '\u1E9Cif',
          new sc_Pair(
            new sc_Pair('\u1E9Cif', new sc_Pair('\u1E9Ca', new sc_Pair('\u1E9Cb', new sc_Pair('\u1E9Cc', null)))),
        ...
        new sc_Pair(
          new sc_Pair(
            ...
            new sc_Pair(
              '\u1E9Ca',
              new sc_Pair(
                new sc_Pair('\u1E9Cif', new sc_Pair('\u1E9Cb', new sc_Pair('\u1E9Cd', new sc_Pair('\u1E9Ce', null)))),
                new sc_Pair(new sc_Pair('\u1E9Cif', new sc_Pair('\u1E9Cc', new sc_Pair('\u1E9Cd', new sc_Pair('\u1E9Ce', null)))), null)
              )
            )
          ),
          null
      ...
      new sc_Pair(
        ...
        new sc_Pair(
          new sc_Pair(
            '\u1E9Cor',
            new sc_Pair(
              new sc_Pair('\u1E9Cequal', new sc_Pair('\u1E9Cx', new sc_Pair(new sc_Pair('\u1E9Czero', null), null))),
              new sc_Pair(new sc_Pair('\u1E9Cnot', new sc_Pair(new sc_Pair('\u1E9Cnumberp', new sc_Pair('\u1E9Cx', null)), null)), null)
            )
          ),
          null
        )
    ...
    new sc_Pair(
      ...
      new sc_Pair(
        new sc_Pair(
          '\u1E9Cplus',
          new sc_Pair(new sc_Pair('\u1E9Cplus', new sc_Pair('\u1E9Cx', new sc_Pair('\u1E9Cy', null))), new sc_Pair('\u1E9Cz', null))
        ),
        new sc_Pair(
          new sc_Pair(
            '\u1E9Cplus',
            new sc_Pair('\u1E9Cx', new sc_Pair(new sc_Pair('\u1E9Cplus', new sc_Pair('\u1E9Cy', new sc_Pair('\u1E9Cz', null))), null))
          ),
          null
        )
      )
    ...
    new sc_Pair(
      ...
      new sc_Pair(
        new sc_Pair(
          ...
          new sc_Pair(
            new sc_Pair('\u1E9Cplus', new sc_Pair('\u1E9Ca', new sc_Pair('\u1E9Cb', null))),
            new sc_Pair(new sc_Pair('\u1E9Cplus', new sc_Pair('\u1E9Ca', new sc_Pair('\u1E9Cc', null))), null)
          )
        ),
        new sc_Pair(
          new sc_Pair(
      ...
      new sc_Pair(
        new sc_Pair(
          ...
          new sc_Pair(
            ...
            new sc_Pair(new sc_Pair('\u1E9Cdifference', new sc_Pair('\u1E9Cx', new sc_Pair('\u1E9Cy', null))), null)
          )
        ),
        new sc_Pair(
          new sc_Pair('\u1E9Cnot', new sc_Pair(new sc_Pair('\u1E9Clessp', new sc_Pair('\u1E9Cy', new sc_Pair('\u1E9Cx', null))), null)),
    ...
    new sc_Pair(
      ...
      new sc_Pair(
        new sc_Pair(
          '\u1E9Cequal',
          new sc_Pair('\u1E9Cx', new sc_Pair(new sc_Pair('\u1E9Cdifference', new sc_Pair('\u1E9Cx', new sc_Pair('\u1E9Cy', null))), null))
        ),
        new sc_Pair(
          new sc_Pair(
            '\u1E9Cand',
    ...
    new sc_Pair(
      ...
      new sc_Pair(
        new sc_Pair(
          '\u1E9Cmeaning',
          new sc_Pair(
            new sc_Pair('\u1E9Cplus-tree', new sc_Pair(new sc_Pair('\u1E9Cappend', new sc_Pair('\u1E9Cx', new sc_Pair('\u1E9Cy', null))), null)),
            new sc_Pair('\u1E9Ca', null)
          )
        ),
        new sc_Pair(
          new sc_Pair(
            '\u1E9Cplus',
            new sc_Pair(
              new sc_Pair('\u1E9Cmeaning', new sc_Pair(new sc_Pair('\u1E9Cplus-tree', new sc_Pair('\u1E9Cx', null)), new sc_Pair('\u1E9Ca', null))),
              new sc_Pair(
                new sc_Pair('\u1E9Cmeaning', new sc_Pair(new sc_Pair('\u1E9Cplus-tree', new sc_Pair('\u1E9Cy', null)), new sc_Pair('\u1E9Ca', null))),
                null
              )
            )
          ),
    ...
    new sc_Pair(
      ...
      new sc_Pair(
        new sc_Pair(
          '\u1E9Cmeaning',
          new sc_Pair(
            new sc_Pair('\u1E9Cplus-tree', new sc_Pair(new sc_Pair('\u1E9Cplus-fringe', new sc_Pair('\u1E9Cx', null)), null)),
            new sc_Pair('\u1E9Ca', null)
          )
        ),
        new sc_Pair(
          new sc_Pair('\u1E9Cfix', new sc_Pair(new sc_Pair('\u1E9Cmeaning', new sc_Pair('\u1E9Cx', new sc_Pair('\u1E9Ca', null))), null)),
          null
        )
      )
    ),
    new sc_Pair(
      ...
      new sc_Pair(
        new sc_Pair(
          '\u1E9Cappend',
          new sc_Pair(new sc_Pair('\u1E9Cappend', new sc_Pair('\u1E9Cx', new sc_Pair('\u1E9Cy', null))), new sc_Pair('\u1E9Cz', null))
        ),
        new sc_Pair(
          new sc_Pair(
            '\u1E9Cappend',
            new sc_Pair('\u1E9Cx', new sc_Pair(new sc_Pair('\u1E9Cappend', new sc_Pair('\u1E9Cy', new sc_Pair('\u1E9Cz', null))), null))
          ),
          null
        )
      )
    ...
    new sc_Pair(
      '\u1E9Cequal',
      new sc_Pair(
        new sc_Pair('\u1E9Creverse', new sc_Pair(new sc_Pair('\u1E9Cappend', new sc_Pair('\u1E9Ca', new sc_Pair('\u1E9Cb', null))), null)),
        new sc_Pair(
          new sc_Pair(
            '\u1E9Cappend',
            new sc_Pair(
        ...
        new sc_Pair(
          new sc_Pair(
            ...
            new sc_Pair(
              ...
              new sc_Pair(new sc_Pair('\u1E9Ctimes', new sc_Pair('\u1E9Cx', new sc_Pair('\u1E9Cz', null))), null)
            )
          ),
          null
        )
    ...
    new sc_Pair(
      ...
      new sc_Pair(
        new sc_Pair(
          '\u1E9Ctimes',
          new sc_Pair(new sc_Pair('\u1E9Ctimes', new sc_Pair('\u1E9Cx', new sc_Pair('\u1E9Cy', null))), new sc_Pair('\u1E9Cz', null))
        ),
        new sc_Pair(
          new sc_Pair(
            '\u1E9Ctimes',
            new sc_Pair('\u1E9Cx', new sc_Pair(new sc_Pair('\u1E9Ctimes', new sc_Pair('\u1E9Cy', new sc_Pair('\u1E9Cz', null))), null))
          ),
          null
        )
      )
        ...
        new sc_Pair(
          new sc_Pair(
            ...
            new sc_Pair(
              '\u1E9Cy',
              new sc_Pair(
                new sc_Pair('\u1E9Cexec', new sc_Pair('\u1E9Cx', new sc_Pair('\u1E9Cpds', new sc_Pair('\u1E9Cenvrn', null)))),
    ...
    new sc_Pair(
      ...
      new sc_Pair(
        ...
        new sc_Pair(
          new sc_Pair('\u1E9Cappend', new sc_Pair(new sc_Pair('\u1E9Cflatten', new sc_Pair('\u1E9Cx', null)), new sc_Pair('\u1E9Cy', null))),
          null
        )
      )
    ),
    new sc_Pair(
      ...
      new sc_Pair(
        new sc_Pair(
          '\u1E9Cmember',
          new sc_Pair('\u1E9Cx', new sc_Pair(new sc_Pair('\u1E9Cappend', new sc_Pair('\u1E9Ca', new sc_Pair('\u1E9Cb', null))), null))
        ),
        new sc_Pair(
          new sc_Pair(
            '\u1E9Cor',
            new sc_Pair(
              ...
              new sc_Pair(new sc_Pair('\u1E9Cmember', new sc_Pair('\u1E9Cx', new sc_Pair('\u1E9Cb', null))), null)
            )
          ),
          null
        )
    ...
    new sc_Pair(
      '\u1E9Cequal',
      new sc_Pair(
        new sc_Pair('\u1E9Cmember', new sc_Pair('\u1E9Cx', new sc_Pair(new sc_Pair('\u1E9Creverse', new sc_Pair('\u1E9Cy', null)), null))),
        new sc_Pair(new sc_Pair('\u1E9Cmember', new sc_Pair('\u1E9Cx', new sc_Pair('\u1E9Cy', null))), null)
      )
    ),
    new sc_Pair(
      '\u1E9Cequal',
      new sc_Pair(
        new sc_Pair('\u1E9Clength', new sc_Pair(new sc_Pair('\u1E9Creverse', new sc_Pair('\u1E9Cx', null)), null)),
    ...
    new sc_Pair(
      ...
      new sc_Pair(
        new sc_Pair(
          '\u1E9Cmember',
          new sc_Pair('\u1E9Ca', new sc_Pair(new sc_Pair('\u1E9Cintersect', new sc_Pair('\u1E9Cb', new sc_Pair('\u1E9Cc', null))), null))
        ),
        new sc_Pair(
          new sc_Pair(
            '\u1E9Cand',
            new sc_Pair(
              ...
              new sc_Pair(new sc_Pair('\u1E9Cmember', new sc_Pair('\u1E9Ca', new sc_Pair('\u1E9Cc', null))), null)
            )
          ),
          null
        )
    ...
    new sc_Pair(
      '\u1E9Cequal',
      new sc_Pair(
        new sc_Pair('\u1E9Cnth', new sc_Pair(new sc_Pair('\u1E9Czero', null), new sc_Pair('\u1E9Ci', null))),
        new sc_Pair(new sc_Pair('\u1E9Czero', null), null)
      )
    ),
    new sc_Pair(
      ...
      new sc_Pair(
        new sc_Pair(
          '\u1E9Cexp',
          new sc_Pair('\u1E9Ci', new sc_Pair(new sc_Pair('\u1E9Cplus', new sc_Pair('\u1E9Cj', new sc_Pair('\u1E9Ck', null))), null))
        ),
        new sc_Pair(
          new sc_Pair(
            '\u1E9Ctimes',
            new sc_Pair(
              ...
              new sc_Pair(new sc_Pair('\u1E9Cexp', new sc_Pair('\u1E9Ci', new sc_Pair('\u1E9Ck', null))), null)
            )
          ),
          null
        )
    ...
    new sc_Pair(
      ...
      new sc_Pair(
        new sc_Pair(
          '\u1E9Cexp',
          new sc_Pair('\u1E9Ci', new sc_Pair(new sc_Pair('\u1E9Ctimes', new sc_Pair('\u1E9Cj', new sc_Pair('\u1E9Ck', null))), null))
        ),
        new sc_Pair(
          new sc_Pair(
            '\u1E9Cexp',
            new sc_Pair(new sc_Pair('\u1E9Cexp', new sc_Pair('\u1E9Ci', new sc_Pair('\u1E9Cj', null))), new sc_Pair('\u1E9Ck', null))
          ),
          null
        )
      )
    ...
    new sc_Pair(
      ...
      new sc_Pair(
        ...
        new sc_Pair(
          new sc_Pair('\u1E9Cappend', new sc_Pair(new sc_Pair('\u1E9Creverse', new sc_Pair('\u1E9Cx', null)), new sc_Pair('\u1E9Cy', null))),
          null
        )
      )
    ),
    new sc_Pair(
      '\u1E9Cequal',
      new sc_Pair(
        new sc_Pair('\u1E9Creverse-loop', new sc_Pair('\u1E9Cx', new sc_Pair(new sc_Pair('\u1E9Cnil', null), null))),
    ...
    new sc_Pair(
      ...
      new sc_Pair(
        new sc_Pair(
          '\u1E9Ccount-list',
          new sc_Pair('\u1E9Cz', new sc_Pair(new sc_Pair('\u1E9Csort-lp', new sc_Pair('\u1E9Cx', new sc_Pair('\u1E9Cy', null))), null))
        ),
        new sc_Pair(
          new sc_Pair(
            '\u1E9Cplus',
            new sc_Pair(
              ...
              new sc_Pair(new sc_Pair('\u1E9Ccount-list', new sc_Pair('\u1E9Cz', new sc_Pair('\u1E9Cy', null))), null)
            )
          ),
          null
        )
      ...
      new sc_Pair(
        new sc_Pair(
          ...
          new sc_Pair(
            ...
            new sc_Pair(new sc_Pair('\u1E9Cappend', new sc_Pair('\u1E9Ca', new sc_Pair('\u1E9Cc', null))), null)
          )
        ),
        new sc_Pair(new sc_Pair('\u1E9Cequal', new sc_Pair('\u1E9Cb', new sc_Pair('\u1E9Cc', null))), null)
      )
    ),
    new sc_Pair(
      '\u1E9Cequal',
        ...
        new sc_Pair(
          ...
          new sc_Pair(
            ...
            new sc_Pair(
              new sc_Pair(
                '\u1E9Ctimes',
                new sc_Pair('\u1E9Cy', new sc_Pair(new sc_Pair('\u1E9Cquotient', new sc_Pair('\u1E9Cx', new sc_Pair('\u1E9Cy', null))), null))
              ),
              null
            )
          )
    ...
    new sc_Pair(
      ...
      new sc_Pair(
        new sc_Pair(
          '\u1E9Cpower-eval',
          new sc_Pair(
            new sc_Pair('\u1E9Cbig-plus1', new sc_Pair('\u1E9Cl', new sc_Pair('\u1E9Ci', new sc_Pair('\u1E9Cbase', null)))),
        ...
        new sc_Pair(
          new sc_Pair(
            '\u1E9Cplus',
            new sc_Pair(new sc_Pair('\u1E9Cpower-eval', new sc_Pair('\u1E9Cl', new sc_Pair('\u1E9Cbase', null))), new sc_Pair('\u1E9Ci', null))
          ),
          null
        )
      )
    ...
    new sc_Pair(
      ...
      new sc_Pair(
        new sc_Pair(
          '\u1E9Cpower-eval',
          new sc_Pair(
            new sc_Pair('\u1E9Cbig-plus', new sc_Pair('\u1E9Cx', new sc_Pair('\u1E9Cy', new sc_Pair('\u1E9Ci', new sc_Pair('\u1E9Cbase', null))))),
            new sc_Pair('\u1E9Cbase', null)
          )
        ),
        new sc_Pair(
            ...
            new sc_Pair(
              ...
              new sc_Pair(
                new sc_Pair(
                  '\u1E9Cplus',
                  new sc_Pair(
                    new sc_Pair('\u1E9Cpower-eval', new sc_Pair('\u1E9Cx', new sc_Pair('\u1E9Cbase', null))),
                    new sc_Pair(new sc_Pair('\u1E9Cpower-eval', new sc_Pair('\u1E9Cy', new sc_Pair('\u1E9Cbase', null))), null)
                  )
                ),
                null
              )
    ...
    new sc_Pair(
      '\u1E9Cequal',
      new sc_Pair(new sc_Pair('\u1E9Cremainder', new sc_Pair('\u1E9Cy', new sc_Pair(1, null))), new sc_Pair(new sc_Pair('\u1E9Czero', null), null))
    ),
    new sc_Pair(
      '\u1E9Cequal',
      new sc_Pair(
        new sc_Pair(
          '\u1E9Clessp',
          new sc_Pair(new sc_Pair('\u1E9Cremainder', new sc_Pair('\u1E9Cx', new sc_Pair('\u1E9Cy', null))), new sc_Pair('\u1E9Cy', null))
        ),
        new sc_Pair(new sc_Pair('\u1E9Cnot', new sc_Pair(new sc_Pair('\u1E9Czerop', new sc_Pair('\u1E9Cy', null)), null)), null)
      )
    ),
    new sc_Pair(
      '\u1E9Cequal',
    ...
    new sc_Pair(
      ...
      new sc_Pair(
        new sc_Pair(
          '\u1E9Clessp',
          new sc_Pair(new sc_Pair('\u1E9Cquotient', new sc_Pair('\u1E9Ci', new sc_Pair('\u1E9Cj', null))), new sc_Pair('\u1E9Ci', null))
        ),
        new sc_Pair(
          new sc_Pair(
            '\u1E9Cand',
            new sc_Pair(
              new sc_Pair('\u1E9Cnot', new sc_Pair(new sc_Pair('\u1E9Czerop', new sc_Pair('\u1E9Ci', null)), null)),
              new sc_Pair(
                new sc_Pair(
                  '\u1E9Cor',
                  new sc_Pair(
                    ...
                    new sc_Pair(
                      new sc_Pair('\u1E9Cnot', new sc_Pair(new sc_Pair('\u1E9Cequal', new sc_Pair('\u1E9Cj', new sc_Pair(1, null))), null)),
                      null
                    )
                  )
                ),
    ...
    new sc_Pair(
      ...
      new sc_Pair(
        new sc_Pair(
          '\u1E9Clessp',
          new sc_Pair(new sc_Pair('\u1E9Cremainder', new sc_Pair('\u1E9Cx', new sc_Pair('\u1E9Cy', null))), new sc_Pair('\u1E9Cx', null))
        ),
        new sc_Pair(
          new sc_Pair(
            '\u1E9Cand',
            new sc_Pair(
              new sc_Pair('\u1E9Cnot', new sc_Pair(new sc_Pair('\u1E9Czerop', new sc_Pair('\u1E9Cy', null)), null)),
              new sc_Pair(
                new sc_Pair('\u1E9Cnot', new sc_Pair(new sc_Pair('\u1E9Czerop', new sc_Pair('\u1E9Cx', null)), null)),
                new sc_Pair(
                  new sc_Pair('\u1E9Cnot', new sc_Pair(new sc_Pair('\u1E9Clessp', new sc_Pair('\u1E9Cx', new sc_Pair('\u1E9Cy', null))), null)),
    ...
    new sc_Pair(
      ...
      new sc_Pair(
        new sc_Pair(
          '\u1E9Cpower-eval',
          new sc_Pair(new sc_Pair('\u1E9Cpower-rep', new sc_Pair('\u1E9Ci', new sc_Pair('\u1E9Cbase', null))), new sc_Pair('\u1E9Cbase', null))
        ),
    ...
    new sc_Pair(
      ...
      new sc_Pair(
          ...
          new sc_Pair(
            new sc_Pair(
              ...
              new sc_Pair(
                ...
                new sc_Pair(
                  new sc_Pair('\u1E9Cpower-rep', new sc_Pair('\u1E9Cj', new sc_Pair('\u1E9Cbase', null))),
        ...
        new sc_Pair(new sc_Pair('\u1E9Cplus', new sc_Pair('\u1E9Ci', new sc_Pair('\u1E9Cj', null))), null)
      )
    ),
    new sc_Pair(
      '\u1E9Cequal',
      new sc_Pair(
        ...
        new sc_Pair(new sc_Pair('\u1E9Cgcd', new sc_Pair('\u1E9Cy', new sc_Pair('\u1E9Cx', null))), null)
      )
    ),
    new sc_Pair(
      '\u1E9Cequal',
      new sc_Pair(
        new sc_Pair(
          '\u1E9Cnth',
          new sc_Pair(new sc_Pair('\u1E9Cappend', new sc_Pair('\u1E9Ca', new sc_Pair('\u1E9Cb', null))), new sc_Pair('\u1E9Ci', null))
        ),
        new sc_Pair(
          new sc_Pair(
            '\u1E9Cappend',
                ...
                new sc_Pair(
                  ...
                  new sc_Pair(
                    ...
                    new sc_Pair(
                      new sc_Pair(
                        '\u1E9Cdifference',
                        new sc_Pair('\u1E9Ci', new sc_Pair(new sc_Pair('\u1E9Clength', new sc_Pair('\u1E9Ca', null)), null))
                      ),
                      null
                    )
                  )
    ...
    new sc_Pair(
      ...
      new sc_Pair(
        new sc_Pair(
          '\u1E9Cdifference',
          new sc_Pair(new sc_Pair('\u1E9Cplus', new sc_Pair('\u1E9Cx', new sc_Pair('\u1E9Cy', null))), new sc_Pair('\u1E9Cx', null))
        ),
        new sc_Pair(new sc_Pair('\u1E9Cfix', new sc_Pair('\u1E9Cy', null)), null)
      )
    ),
    new sc_Pair(
      ...
      new sc_Pair(
        new sc_Pair(
          '\u1E9Cdifference',
          new sc_Pair(new sc_Pair('\u1E9Cplus', new sc_Pair('\u1E9Cy', new sc_Pair('\u1E9Cx', null))), new sc_Pair('\u1E9Cx', null))
        ),
        new sc_Pair(new sc_Pair('\u1E9Cfix', new sc_Pair('\u1E9Cy', null)), null)
      )
    ),
      ...
      new sc_Pair(
        new sc_Pair(
          ...
          new sc_Pair(
            ...
            new sc_Pair(new sc_Pair('\u1E9Cplus', new sc_Pair('\u1E9Cx', new sc_Pair('\u1E9Cz', null))), null)
          )
        ),
        new sc_Pair(new sc_Pair('\u1E9Cdifference', new sc_Pair('\u1E9Cy', new sc_Pair('\u1E9Cz', null))), null)
      )
    ),
    new sc_Pair(
      '\u1E9Cequal',
      new sc_Pair(
        new sc_Pair(
          '\u1E9Ctimes',
          new sc_Pair('\u1E9Cx', new sc_Pair(new sc_Pair('\u1E9Cdifference', new sc_Pair('\u1E9Cc', new sc_Pair('\u1E9Cw', null))), null))
        ),
        new sc_Pair(
          new sc_Pair(
            '\u1E9Cdifference',
            new sc_Pair(
              ...
              new sc_Pair(new sc_Pair('\u1E9Ctimes', new sc_Pair('\u1E9Cw', new sc_Pair('\u1E9Cx', null))), null)
            )
          ),
          null
        )
    ...
    new sc_Pair(
      ...
      new sc_Pair(
        new sc_Pair(
          '\u1E9Cremainder',
          new sc_Pair(new sc_Pair('\u1E9Ctimes', new sc_Pair('\u1E9Cx', new sc_Pair('\u1E9Cz', null))), new sc_Pair('\u1E9Cz', null))
        ),
        new sc_Pair(new sc_Pair('\u1E9Czero', null), null)
      )
    ),
      ...
      new sc_Pair(
        new sc_Pair(
          ...
          new sc_Pair(
            new sc_Pair(
              '\u1E9Cplus',
              new sc_Pair('\u1E9Cb', new sc_Pair(new sc_Pair('\u1E9Cplus', new sc_Pair('\u1E9Ca', new sc_Pair('\u1E9Cc', null))), null))
            ),
            new sc_Pair('\u1E9Ca', null)
          )
        ),
        new sc_Pair(new sc_Pair('\u1E9Cplus', new sc_Pair('\u1E9Cb', new sc_Pair('\u1E9Cc', null))), null)
      )
    ),
    new sc_Pair(
      '\u1E9Cequal',
      new sc_Pair(
        new sc_Pair(
          '\u1E9Cdifference',
          new sc_Pair(
            new sc_Pair('\u1E9Cadd1', new sc_Pair(new sc_Pair('\u1E9Cplus', new sc_Pair('\u1E9Cy', new sc_Pair('\u1E9Cz', null))), null)),
            new sc_Pair('\u1E9Cz', null)
          )
        ),
    ...
    new sc_Pair(
      ...
      new sc_Pair(
        ...
        new sc_Pair(new sc_Pair('\u1E9Clessp', new sc_Pair('\u1E9Cy', new sc_Pair('\u1E9Cz', null))), null)
      )
    ),
    new sc_Pair(
      '\u1E9Cequal',
      new sc_Pair(
        new sc_Pair(
          ...
          new sc_Pair(
            ...
            new sc_Pair(new sc_Pair('\u1E9Ctimes', new sc_Pair('\u1E9Cy', new sc_Pair('\u1E9Cz', null))), null)
          )
        ),
        new sc_Pair(
          new sc_Pair(
            '\u1E9Cand',
            new sc_Pair(
              new sc_Pair('\u1E9Cnot', new sc_Pair(new sc_Pair('\u1E9Czerop', new sc_Pair('\u1E9Cz', null)), null)),
              new sc_Pair(new sc_Pair('\u1E9Clessp', new sc_Pair('\u1E9Cx', new sc_Pair('\u1E9Cy', null))), null)
            )
          ),
          null
        )
    ...
    new sc_Pair(
      ...
      new sc_Pair(
        new sc_Pair(
          '\u1E9Clessp',
          new sc_Pair('\u1E9Cy', new sc_Pair(new sc_Pair('\u1E9Cplus', new sc_Pair('\u1E9Cx', new sc_Pair('\u1E9Cy', null))), null))
        ),
        new sc_Pair(new sc_Pair('\u1E9Cnot', new sc_Pair(new sc_Pair('\u1E9Czerop', new sc_Pair('\u1E9Cx', null)), null)), null)
      )
    ),
    new sc_Pair(
      '\u1E9Cequal',
      new sc_Pair(
        ...
        new sc_Pair(
          new sc_Pair(
            '\u1E9Ctimes',
            new sc_Pair('\u1E9Cz', new sc_Pair(new sc_Pair('\u1E9Cgcd', new sc_Pair('\u1E9Cx', new sc_Pair('\u1E9Cy', null))), null))
          ),
          null
        )
      )
    ...
    new sc_Pair(
      '\u1E9Cequal',
      new sc_Pair(
        new sc_Pair('\u1E9Cvalue', new sc_Pair(new sc_Pair('\u1E9Cnormalize', new sc_Pair('\u1E9Cx', null)), new sc_Pair('\u1E9Ca', null))),
        new sc_Pair(new sc_Pair('\u1E9Cvalue', new sc_Pair('\u1E9Cx', new sc_Pair('\u1E9Ca', null))), null)
      )
    ),
    new sc_Pair(
      '\u1E9Cequal',
      new sc_Pair(
        new sc_Pair(
          ...
          new sc_Pair(
            ...
            new sc_Pair(new sc_Pair('\u1E9Ccons', new sc_Pair('\u1E9Cy', new sc_Pair(new sc_Pair('\u1E9Cnil', null), null))), null)
          )
        ),
        new sc_Pair(
          new sc_Pair(
            ...
            new sc_Pair(
              ...
              new sc_Pair(new sc_Pair('\u1E9Cequal', new sc_Pair('\u1E9Cx', new sc_Pair('\u1E9Cy', null))), null)
            )
          ),
          null
        )
    ...
    new sc_Pair(
      '\u1E9Cequal',
      new sc_Pair(
        new sc_Pair('\u1E9Clistp', new sc_Pair(new sc_Pair('\u1E9Cgopher', new sc_Pair('\u1E9Cx', null)), null)),
    ...
    new sc_Pair(
      ...
      new sc_Pair(
        new sc_Pair(
          '\u1E9Cequal',
          new sc_Pair(
            new sc_Pair('\u1E9Cgreatest-factor', new sc_Pair('\u1E9Cx', new sc_Pair('\u1E9Cy', null))),
            new sc_Pair(new sc_Pair('\u1E9Czero', null), null)
          )
        ),
        new sc_Pair(
            ...
            new sc_Pair(
              new sc_Pair(
                ...
                new sc_Pair(
                  ...
                  new sc_Pair(new sc_Pair('\u1E9Cequal', new sc_Pair('\u1E9Cy', new sc_Pair(1, null))), null)
                )
              ),
              new sc_Pair(new sc_Pair('\u1E9Cequal', new sc_Pair('\u1E9Cx', new sc_Pair(new sc_Pair('\u1E9Czero', null), null))), null)
            )
          ),
          null
        )
    ...
    new sc_Pair(
      ...
      new sc_Pair(
        new sc_Pair(
          '\u1E9Cequal',
          new sc_Pair(new sc_Pair('\u1E9Cgreatest-factor', new sc_Pair('\u1E9Cx', new sc_Pair('\u1E9Cy', null))), new sc_Pair(1, null))
        ),
    ...
    new sc_Pair(
      '\u1E9Cequal',
      new sc_Pair(
        new sc_Pair('\u1E9Cnumberp', new sc_Pair(new sc_Pair('\u1E9Cgreatest-factor', new sc_Pair('\u1E9Cx', new sc_Pair('\u1E9Cy', null))), null)),
        new sc_Pair(
          new sc_Pair(
            '\u1E9Cnot',
            new sc_Pair(
    ...
    new sc_Pair(
      '\u1E9Cequal',
      new sc_Pair(
        new sc_Pair('\u1E9Ctimes-list', new sc_Pair(new sc_Pair('\u1E9Cappend', new sc_Pair('\u1E9Cx', new sc_Pair('\u1E9Cy', null))), null)),
        new sc_Pair(
          new sc_Pair(
            '\u1E9Ctimes',
            new sc_Pair(
    ...
    new sc_Pair(
      '\u1E9Cequal',
      new sc_Pair(
        new sc_Pair('\u1E9Cprime-list', new sc_Pair(new sc_Pair('\u1E9Cappend', new sc_Pair('\u1E9Cx', new sc_Pair('\u1E9Cy', null))), null)),
        new sc_Pair(
          new sc_Pair(
            '\u1E9Cand',
            new sc_Pair(
    ...
    new sc_Pair(
      ...
      new sc_Pair(
        new sc_Pair(
          '\u1E9Cequal',
          new sc_Pair('\u1E9Cz', new sc_Pair(new sc_Pair('\u1E9Ctimes', new sc_Pair('\u1E9Cw', new sc_Pair('\u1E9Cz', null))), null))
        ),
        new sc_Pair(
          new sc_Pair(
            '\u1E9Cand',
            new sc_Pair(
              ...
              new sc_Pair(
                new sc_Pair(
                  '\u1E9Cor',
                  new sc_Pair(
                    new sc_Pair('\u1E9Cequal', new sc_Pair('\u1E9Cz', new sc_Pair(new sc_Pair('\u1E9Czero', null), null))),
                    new sc_Pair(new sc_Pair('\u1E9Cequal', new sc_Pair('\u1E9Cw', new sc_Pair(1, null))), null)
                  )
                ),
                null
              )
    ...
    new sc_Pair(
      ...
      new sc_Pair(
        new sc_Pair(
          '\u1E9Cequal',
          new sc_Pair('\u1E9Cx', new sc_Pair(new sc_Pair('\u1E9Ctimes', new sc_Pair('\u1E9Cx', new sc_Pair('\u1E9Cy', null))), null))
        ),
        new sc_Pair(
          new sc_Pair(
            '\u1E9Cor',
    ...
    new sc_Pair(
      ...
      new sc_Pair(
        new sc_Pair(
          '\u1E9Cremainder',
          new sc_Pair(new sc_Pair('\u1E9Ctimes', new sc_Pair('\u1E9Cy', new sc_Pair('\u1E9Cx', null))), new sc_Pair('\u1E9Cy', null))
        ),
        new sc_Pair(new sc_Pair('\u1E9Czero', null), null)
      )
    ),
    new sc_Pair(
      ...
      new sc_Pair(
        new sc_Pair(
          '\u1E9Cequal',
          new sc_Pair(new sc_Pair('\u1E9Ctimes', new sc_Pair('\u1E9Ca', new sc_Pair('\u1E9Cb', null))), new sc_Pair(1, null))
        ),
        new sc_Pair(
          sc_list(
            '\u1E9Cand',
            new sc_Pair(
              '\u1E9Cnot',
              new sc_Pair(new sc_Pair('\u1E9Cequal', new sc_Pair('\u1E9Ca', new sc_Pair(new sc_Pair('\u1E9Czero', null), null))), null)
            ),
            new sc_Pair(
              '\u1E9Cnot',
              new sc_Pair(new sc_Pair('\u1E9Cequal', new sc_Pair('\u1E9Cb', new sc_Pair(new sc_Pair('\u1E9Czero', null), null))), null)
            ),
            new sc_Pair('\u1E9Cnumberp', new sc_Pair('\u1E9Ca', null)),
            new sc_Pair('\u1E9Cnumberp', new sc_Pair('\u1E9Cb', null)),
            new sc_Pair(
              '\u1E9Cequal',
              new sc_Pair(new sc_Pair('\u1E9Csub1', new sc_Pair('\u1E9Ca', null)), new sc_Pair(new sc_Pair('\u1E9Czero', null), null))
            ),
            new sc_Pair(
              '\u1E9Cequal',
              new sc_Pair(new sc_Pair('\u1E9Csub1', new sc_Pair('\u1E9Cb', null)), new sc_Pair(new sc_Pair('\u1E9Czero', null), null))
            )
          ),
          null
        )
    ...
    new sc_Pair(
      ...
      new sc_Pair(
        new sc_Pair(
          '\u1E9Clessp',
          new sc_Pair(
            new sc_Pair('\u1E9Clength', new sc_Pair(new sc_Pair('\u1E9Cdelete', new sc_Pair('\u1E9Cx', new sc_Pair('\u1E9Cl', null))), null)),
            new sc_Pair(new sc_Pair('\u1E9Clength', new sc_Pair('\u1E9Cl', null)), null)
          )
        ),
        new sc_Pair(new sc_Pair('\u1E9Cmember', new sc_Pair('\u1E9Cx', new sc_Pair('\u1E9Cl', null))), null)
      )
    ),
    new sc_Pair(
      '\u1E9Cequal',
      new sc_Pair(
        new sc_Pair('\u1E9Csort2', new sc_Pair(new sc_Pair('\u1E9Cdelete', new sc_Pair('\u1E9Cx', new sc_Pair('\u1E9Cl', null))), null)),
        new sc_Pair(
          new sc_Pair('\u1E9Cdelete', new sc_Pair('\u1E9Cx', new sc_Pair(new sc_Pair('\u1E9Csort2', new sc_Pair('\u1E9Cl', null)), null))),
          null
        )
      )
    ),
    ...
    new sc_Pair(
      ...
      new sc_Pair(
                                ...
                                new sc_Pair(
                                  ...
                                  new sc_Pair(
                                    new sc_Pair(
                                      ...
                                      new sc_Pair(
                                        '\u1E9Cx5',
                                        new sc_Pair(new sc_Pair('\u1E9Ccons', new sc_Pair('\u1E9Cx6', new sc_Pair('\u1E9Cx7', null))), null)
                                      )
                                    ),
                                    null
                                  )
        ...
        new sc_Pair(new sc_Pair('\u1E9Cplus', new sc_Pair(6, new sc_Pair(new sc_Pair('\u1E9Clength', new sc_Pair('\u1E9Cx7', null)), null))), null)
      )
    ),
    new sc_Pair(
      '\u1E9Cequal',
      new sc_Pair(
        new sc_Pair(
          '\u1E9Cdifference',
          new sc_Pair(new sc_Pair('\u1E9Cadd1', new sc_Pair(new sc_Pair('\u1E9Cadd1', new sc_Pair('\u1E9Cx', null)), null)), new sc_Pair(2, null))
        ),
        new sc_Pair(new sc_Pair('\u1E9Cfix', new sc_Pair('\u1E9Cx', null)), null)
      )
    ),
      ...
      new sc_Pair(
        new sc_Pair(
          ...
          new sc_Pair(
            new sc_Pair(
              '\u1E9Cplus',
              new sc_Pair('\u1E9Cx', new sc_Pair(new sc_Pair('\u1E9Cplus', new sc_Pair('\u1E9Cx', new sc_Pair('\u1E9Cy', null))), null))
            ),
            new sc_Pair(2, null)
          )
        ),
        new sc_Pair(
          new sc_Pair(
            '\u1E9Cplus',
            new sc_Pair('\u1E9Cx', new sc_Pair(new sc_Pair('\u1E9Cquotient', new sc_Pair('\u1E9Cy', new sc_Pair(2, null))), null))
          ),
          null
        )
      )
    ...
    new sc_Pair(
      '\u1E9Cequal',
      new sc_Pair(
        new sc_Pair('\u1E9Csigma', new sc_Pair(new sc_Pair('\u1E9Czero', null), new sc_Pair('\u1E9Ci', null))),
        new sc_Pair(
          new sc_Pair(
            '\u1E9Cquotient',
            new sc_Pair(
              new sc_Pair('\u1E9Ctimes', new sc_Pair('\u1E9Ci', new sc_Pair(new sc_Pair('\u1E9Cadd1', new sc_Pair('\u1E9Ci', null)), null))),
              new sc_Pair(2, null)
            )
          ),
          null
    ...
    new sc_Pair(
      '\u1E9Cequal',
      new sc_Pair(
        new sc_Pair('\u1E9Cplus', new sc_Pair('\u1E9Cx', new sc_Pair(new sc_Pair('\u1E9Cadd1', new sc_Pair('\u1E9Cy', null)), null))),
        new sc_Pair(
          new sc_Pair(
            '\u1E9Cif',
            new sc_Pair(
              ...
              new sc_Pair(
                new sc_Pair('\u1E9Cadd1', new sc_Pair(new sc_Pair('\u1E9Cplus', new sc_Pair('\u1E9Cx', new sc_Pair('\u1E9Cy', null))), null)),
      ...
      new sc_Pair(
        new sc_Pair(
          ...
          new sc_Pair(
            ...
            new sc_Pair(new sc_Pair('\u1E9Cdifference', new sc_Pair('\u1E9Cz', new sc_Pair('\u1E9Cy', null))), null)
          )
        ),
        new sc_Pair(
          new sc_Pair(
            ...
            new sc_Pair(
              ...
              new sc_Pair(
                new sc_Pair('\u1E9Cnot', new sc_Pair(new sc_Pair('\u1E9Clessp', new sc_Pair('\u1E9Cy', new sc_Pair('\u1E9Cz', null))), null)),
                new sc_Pair(
                  new sc_Pair(
                    '\u1E9Cif',
                    new sc_Pair(
                      new sc_Pair('\u1E9Clessp', new sc_Pair('\u1E9Cz', new sc_Pair('\u1E9Cy', null))),
                      new sc_Pair(
                        new sc_Pair('\u1E9Cnot', new sc_Pair(new sc_Pair('\u1E9Clessp', new sc_Pair('\u1E9Cy', new sc_Pair('\u1E9Cx', null))), null)),
                        new sc_Pair(
                          new sc_Pair(
                            ...
                            new sc_Pair(
                              new sc_Pair('\u1E9Cfix', new sc_Pair('\u1E9Cx', null)),
                              new sc_Pair(new sc_Pair('\u1E9Cfix', new sc_Pair('\u1E9Cz', null)), null)
                            )
                          ),
                          null
                        )
    ...
    new sc_Pair(
      ...
      new sc_Pair(
        new sc_Pair(
          '\u1E9Cmeaning',
          new sc_Pair(
            new sc_Pair('\u1E9Cplus-tree', new sc_Pair(new sc_Pair('\u1E9Cdelete', new sc_Pair('\u1E9Cx', new sc_Pair('\u1E9Cy', null))), null)),
            new sc_Pair('\u1E9Ca', null)
          )
        ),
        new sc_Pair(
              ...
              new sc_Pair(
                new sc_Pair(
                  ...
                  new sc_Pair(
                    new sc_Pair(
                      '\u1E9Cmeaning',
                      new sc_Pair(new sc_Pair('\u1E9Cplus-tree', new sc_Pair('\u1E9Cy', null)), new sc_Pair('\u1E9Ca', null))
                    ),
                    new sc_Pair(new sc_Pair('\u1E9Cmeaning', new sc_Pair('\u1E9Cx', new sc_Pair('\u1E9Ca', null))), null)
                  )
                ),
                new sc_Pair(
                  new sc_Pair(
    ...
    new sc_Pair(
      '\u1E9Cequal',
      new sc_Pair(
        new sc_Pair('\u1E9Ctimes', new sc_Pair('\u1E9Cx', new sc_Pair(new sc_Pair('\u1E9Cadd1', new sc_Pair('\u1E9Cy', null)), null))),
        new sc_Pair(
          new sc_Pair(
            '\u1E9Cif',
            new sc_Pair(
    ...
    new sc_Pair(
      '\u1E9Cequal',
      new sc_Pair(
        new sc_Pair('\u1E9Cnth', new sc_Pair(new sc_Pair('\u1E9Cnil', null), new sc_Pair('\u1E9Ci', null))),
        new sc_Pair(
          new sc_Pair(
            '\u1E9Cif',
            new sc_Pair(
              new sc_Pair('\u1E9Czerop', new sc_Pair('\u1E9Ci', null)),
              new sc_Pair(new sc_Pair('\u1E9Cnil', null), new sc_Pair(new sc_Pair('\u1E9Czero', null), null))
            )
          ),
          null
        )
    ...
    new sc_Pair(
      '\u1E9Cequal',
      new sc_Pair(
        new sc_Pair('\u1E9Clast', new sc_Pair(new sc_Pair('\u1E9Cappend', new sc_Pair('\u1E9Ca', new sc_Pair('\u1E9Cb', null))), null)),
        new sc_Pair(
          new sc_Pair(
            '\u1E9Cif',
            new sc_Pair(
                    ...
                    new sc_Pair(
                      ...
                      new sc_Pair(
                        new sc_Pair(
                          '\u1E9Ccons',
                          new sc_Pair(
                            new sc_Pair('\u1E9Ccar', new sc_Pair(new sc_Pair('\u1E9Clast', new sc_Pair('\u1E9Ca', null)), null)),
                            new sc_Pair('\u1E9Cb', null)
                          )
                        ),
                        new sc_Pair('\u1E9Cb', null)
    ...
    new sc_Pair(
      ...
      new sc_Pair(
        new sc_Pair(
          '\u1E9Cequal',
          new sc_Pair(new sc_Pair('\u1E9Clessp', new sc_Pair('\u1E9Cx', new sc_Pair('\u1E9Cy', null))), new sc_Pair('\u1E9Cz', null))
        ),
        new sc_Pair(
          new sc_Pair(
            '\u1E9Cif',
            new sc_Pair(
              new sc_Pair('\u1E9Clessp', new sc_Pair('\u1E9Cx', new sc_Pair('\u1E9Cy', null))),
              new sc_Pair(
                new sc_Pair('\u1E9Cequal', new sc_Pair(new sc_Pair('\u1E9Ct', null), new sc_Pair('\u1E9Cz', null))),
                new sc_Pair(new sc_Pair('\u1E9Cequal', new sc_Pair(new sc_Pair('\u1E9Cf', null), new sc_Pair('\u1E9Cz', null))), null)
              )
            )
          ),
          null
        ...
        new sc_Pair(
          new sc_Pair(
            ...
            new sc_Pair(
              ...
              new sc_Pair(
                new sc_Pair('\u1E9Cassignment', new sc_Pair('\u1E9Cx', new sc_Pair('\u1E9Ca', null))),
                new sc_Pair(new sc_Pair('\u1E9Cassignment', new sc_Pair('\u1E9Cx', new sc_Pair('\u1E9Cb', null))), null)
              )
            )
          ),
          null
    ...
    new sc_Pair(
      '\u1E9Cequal',
      new sc_Pair(
        new sc_Pair('\u1E9Ccar', new sc_Pair(new sc_Pair('\u1E9Cgopher', new sc_Pair('\u1E9Cx', null)), null)),
        new sc_Pair(
          new sc_Pair(
            '\u1E9Cif',
            new sc_Pair(
              ...
              new sc_Pair(
                new sc_Pair('\u1E9Ccar', new sc_Pair(new sc_Pair('\u1E9Cflatten', new sc_Pair('\u1E9Cx', null)), null)),
                new sc_Pair(new sc_Pair('\u1E9Czero', null), null)
              )
            )
          ),
    ...
    new sc_Pair(
      ...
      new sc_Pair(
        new sc_Pair(
          '\u1E9Cflatten',
          new sc_Pair(new sc_Pair('\u1E9Ccdr', new sc_Pair(new sc_Pair('\u1E9Cgopher', new sc_Pair('\u1E9Cx', null)), null)), null)
        ),
        new sc_Pair(
          new sc_Pair(
            '\u1E9Cif',
            new sc_Pair(
              new sc_Pair('\u1E9Clistp', new sc_Pair('\u1E9Cx', null)),
              new sc_Pair(
                new sc_Pair('\u1E9Ccdr', new sc_Pair(new sc_Pair('\u1E9Cflatten', new sc_Pair('\u1E9Cx', null)), null)),
                new sc_Pair(
                  new sc_Pair('\u1E9Ccons', new sc_Pair(new sc_Pair('\u1E9Czero', null), new sc_Pair(new sc_Pair('\u1E9Cnil', null), null))),
                  null
                )
              )
            )
      ...
      new sc_Pair(
        ...
        new sc_Pair(
          new sc_Pair(
            ...
            new sc_Pair(
              new sc_Pair('\u1E9Czerop', new sc_Pair('\u1E9Cy', null)),
              new sc_Pair(new sc_Pair('\u1E9Czero', null), new sc_Pair(new sc_Pair('\u1E9Cfix', new sc_Pair('\u1E9Cx', null)), null))
            )
          ),
          null
        )
    ...
    new sc_Pair(
      ...
      new sc_Pair(
        new sc_Pair(
          ...
          new sc_Pair(
            '\u1E9Cj',
            new sc_Pair(new sc_Pair('\u1E9Cset', new sc_Pair('\u1E9Ci', new sc_Pair('\u1E9Cval', new sc_Pair('\u1E9Cmem', null)))), null)
          )
        ),
        new sc_Pair(
          new sc_Pair(
            ...
            new sc_Pair(
              ...
              new sc_Pair('\u1E9Cval', new sc_Pair(new sc_Pair('\u1E9Cget', new sc_Pair('\u1E9Cj', new sc_Pair('\u1E9Cmem', null))), null))
            )
          ),
          null
        )
      ...
      new sc_Pair(
        ...
        new sc_Pair(
          new sc_Pair(
            ...
            new sc_Pair(
              new sc_Pair('\u1E9Cplus', new sc_Pair('\u1E9Ca', new sc_Pair('\u1E9Cb', null))),
              new sc_Pair(new sc_Pair('\u1E9Cplus', new sc_Pair('\u1E9Cc', new sc_Pair(new sc_Pair('\u1E9Czero', null), null))), null)
            )
          ),
          null
        )
          ...
          new sc_Pair(
            new sc_Pair(
              ...
              new sc_Pair(
                ...
                new sc_Pair(new sc_Pair('\u1E9Cplus', new sc_Pair('\u1E9Cc', new sc_Pair('\u1E9Cd', null))), null)
              )
            ),
            null
          )
          ...
          new sc_Pair(
            new sc_Pair(
              ...
              new sc_Pair(
                '\u1E9Clessp',
                new sc_Pair(
                  new sc_Pair('\u1E9Cremainder', new sc_Pair('\u1E9Ca', new sc_Pair('\u1E9Cb', null))),
                  new sc_Pair(
                    new sc_Pair('\u1E9Cmember', new sc_Pair('\u1E9Ca', new sc_Pair(new sc_Pair('\u1E9Clength', new sc_Pair('\u1E9Cb', null)), null))),
                    null
                  )
                )
              )
  ...
  translate_term_nboyer = function (term) {
    ...
    return !(term instanceof sc_Pair)
      ...
      : new sc_Pair(
          ...
          ((lst = term.cdr), lst === null ? null : new sc_Pair(translate_term_nboyer(lst.car), translate_args_nboyer(lst.cdr)))
        );
  };
  translate_args_nboyer = function (lst) {
    ...
    return lst === null
      ...
      : new sc_Pair(
          ((term = lst.car),
          !(term instanceof sc_Pair) ? term : new sc_Pair(BgL_sc_symbolzd2ze3symbolzd2record_1ze3_nboyer(term.car), translate_args_nboyer(term.cdr))),
          ((sc_lst_5 = lst.cdr), sc_lst_5 === null ? null : new sc_Pair(translate_term_nboyer(sc_lst_5.car), translate_args_nboyer(sc_lst_5.cdr)))
        );
  };
  ...
  translate_alist_nboyer = function (alist) {
    ...
    return alist === null
      ...
      : new sc_Pair(
          ...
          sc_alist_6 === null
            ? null
            : new sc_Pair(new sc_Pair(sc_alist_6.car.car, translate_term_nboyer(sc_alist_6.car.cdr)), translate_alist_nboyer(sc_alist_6.cdr)))
        );
  };
  apply_subst_nboyer = function (alist, term) {
    ...
    return !(term instanceof sc_Pair)
      ...
      : new sc_Pair(
          term.car,
          ((lst = term.cdr), lst === null ? null : new sc_Pair(apply_subst_nboyer(alist, lst.car), apply_subst_lst_nboyer(alist, lst.cdr)))
        );
  };
  apply_subst_lst_nboyer = function (alist, lst) {
    ...
    return lst === null
      ...
      : new sc_Pair(
          ...
          ((sc_lst_7 = lst.cdr),
          sc_lst_7 === null ? null : new sc_Pair(apply_subst_nboyer(alist, sc_lst_7.car), apply_subst_lst_nboyer(alist, sc_lst_7.cdr)))
        );
  };
  tautologyp_nboyer = function (sc_x_11, true_lst, false_lst) {
    ...
    while (true) {
      if (
        ...
        sc_tmp1126_10 !== false ? sc_tmp1126_10 : is_term_member_nboyer(sc_x_11, true_lst)) !== false
      )
        return true;
      else if (
    ...
    var sc_lst_13;
    {
      ...
      if (!(term instanceof sc_Pair)) return term;
        ...
        sc_term_12 = new sc_Pair(
          term.car,
          ((sc_lst_13 = term.cdr), sc_lst_13 === null ? null : new sc_Pair(rewrite_nboyer(sc_lst_13.car), rewrite_args_nboyer(sc_lst_13.cdr)))
        );
  ...
  rewrite_args_nboyer = function (lst) {
    ...
    return lst === null
      ...
      : new sc_Pair(
          ...
          ((sc_lst_14 = lst.cdr), sc_lst_14 === null ? null : new sc_Pair(rewrite_nboyer(sc_lst_14.car), rewrite_args_nboyer(sc_lst_14.cdr)))
        );
  };
    ...
    return sc_isEqual(n, 1)
      ...
      : sc_list(
          ...
          sc_isEqual(sc_n_15, 1)
            ? sc_list('\u1E9Cimplies', 0, 1)
            : sc_list('\u1E9Cand', sc_list('\u1E9Cimplies', sc_n_15 - 1, sc_n_15), trans_of_implies1_nboyer(sc_n_15 - 1)))
        );
  };
    ...
    var sc_term_19;
    {
      ...
      false_term_nboyer =
        ...
        !(sc_term_19 instanceof sc_Pair)
          ? sc_term_19
          : new sc_Pair(BgL_sc_symbolzd2ze3symbolzd2record_1ze3_nboyer(sc_term_19.car), translate_args_nboyer(sc_term_19.cdr)));
      true_term_nboyer =
        ((sc_term_18 = new sc_Pair('\u1E9Ct', null)),
        !(sc_term_18 instanceof sc_Pair)
          ? sc_term_18
          : new sc_Pair(BgL_sc_symbolzd2ze3symbolzd2record_1ze3_nboyer(sc_term_18.car), translate_args_nboyer(sc_term_18.cdr)));
  ...
  BgL_testzd2boyerzd2 = function (n) {
    ...
    var sc_term_22;
    {
      ...
      else optrOpnd = new sc_Pair(BgL_sc_symbolzd2ze3symbolzd2record_1ze3_nboyer(sc_term_22.car), translate_args_nboyer(sc_term_22.cdr));
      sc_term_21 = apply_subst_nboyer(
        const_nboyer === null
          ? null
          : new sc_Pair(new sc_Pair(const_nboyer.car.car, translate_term_nboyer(const_nboyer.car.cdr)), translate_alist_nboyer(const_nboyer.cdr)),
        optrOpnd
      );
...
var const_earley;
{
  const_earley = new sc_Pair(
    new sc_Pair('\u1E9Cs', new sc_Pair(new sc_Pair('\u1E9Ca', null), new sc_Pair(new sc_Pair('\u1E9Cs', new sc_Pair('\u1E9Cs', null)), null))),
    null
  );
        ...
        ((BgL_sc_defzd2loop_9zd2 = function (defs, sc_nts_11) {
          ...
          return defs instanceof sc_Pair
            ? ((def = defs.car),
              ...
              rule_loop(def.cdr, sc_member(head, sc_nts_11) !== false ? sc_nts_11 : new sc_Pair(head, sc_nts_11)))
        ...
        var BgL_sc_nbzd2derivzd2treesza2_48za2;
        {
          ...
          BgL_sc_confzd2setzd2adjoinza2za2_46z00 = function (sc_states_60, BgL_sc_statesza2_61za2, BgL_sc_statezd2num_62zd2, sc_conf_63, i) {
            ...
            return (
              ...
              ((conf_set = state[sc_conf_63 + 1]), conf_set !== false ? conf_set[i + 5] : false) !== false
                ...
                while (l instanceof sc_Pair) {
                  {
                    ...
                    if (((state = sc_states_106[j]), (conf_set = state[sc_conf_107 + 1]), conf_set !== false ? conf_set[i + 5] : false) !== false) {
                      l = l.cdr;
                      trees = sc_append(
                        deriv_trees(sc_conf_107, i, j, sc_enders_102, sc_steps_103, sc_names_104, sc_toks_105, sc_states_106, BgL_sc_nbzd2nts_108zd2),
                        trees
                      );
                    } else l = l.cdr;
                  }
          ...
          nb_deriv_trees = function (sc_conf_110, i, j, sc_enders_111, sc_steps_112, sc_toks_113, sc_states_114, BgL_sc_nbzd2nts_115zd2) {
            ...
            return (
              (prev = sc_conf_110 - 1),
              ((tmp1124 = sc_conf_110 < BgL_sc_nbzd2nts_115zd2), tmp1124 !== false ? tmp1124 : sc_steps_112[prev] < 0) !== false
                ? 1
                      ...
                      if (l instanceof sc_Pair) {
                        ...
                        if (ender_set !== false) {
                          ...
                          while (k >= 0) {
                            if (
                              k >= i &&
                              ((state = sc_states_114[k]), (conf_set = state[prev + 1]), conf_set !== false ? conf_set[i + 5] : false) !== false
                            ) {
                ...
                while (l instanceof sc_Pair) {
                  {
                    ...
                    if (((state = sc_states_123[j]), (conf_set = state[sc_conf_124 + 1]), conf_set !== false ? conf_set[i + 5] : false) !== false) {
                      l = l.cdr;
                      nb_trees =
                        nb_deriv_trees(sc_conf_124, i, j, sc_enders_120, sc_steps_121, sc_toks_122, sc_states_123, BgL_sc_nbzd2nts_125zd2) + nb_trees;
                    } else l = l.cdr;
                  }
                }
                return nb_trees;
