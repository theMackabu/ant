...
test('shell stdout is Buffer', Buffer.isBuffer(result.stdout), true);
test('shell stderr is Buffer', Buffer.isBuffer(result.stderr), true);
test('shell stdout Buffer text', result.stdout.toString('utf8'), 'hello\n');
test('shell stdout Buffer hex', result.stdout.toString('hex'), '68656c6c6f0a');
